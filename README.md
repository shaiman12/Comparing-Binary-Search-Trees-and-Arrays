...
**Part	3:	Test	Values**
I	tested	both	the	PowerBSTApp	and	the	PowerArrayApp	with	the	following	
known	values:	16/12/2006/20:42:00,	17/12/2006/01:20:00	and	
16/12/2006/17:43:00.	I	also	tested	the	values	for	when	I	created	a	random	
date/time	string.	I	also	tested	what	happens	when	no	arguments	are	passed	to	
the	apps.	I	will	display	the	first	10	and	last	10	lines	of	output	when	no	arguments	
are	passed	to	the	apps.	The	results	of	these	tests	are	shown	below:
**PowerArrayApp PowerBSTApp**

```
Part	4:	Results	and	discussion
Here	are	the	graphs	I	crated	from	my	text	files	after	executing	the	script:
```

The	results	shown	above	are	as	hypothesized	in	that	the	binary	search	tree	way	
outperforms	the	classic	array	implementation. This	shows	that	the	binary	search	
tree	is	way	more	efficient,	time-saving	and	resource-saving data	structure	than	
the	typical	array	infrastructure.	In	both	the	average	and	the	best	case	the	
operation	counts	for	the	binary	search	tree	are	way	lower	and	thus	we	can	
conclude	that	the	binary	search	tree	is	a	significantly	more	effective	and	
resourceful	way	of	storing	data. The	expected	best	case	of	searching	for	both	the	
binary	search	tree	and	an	array	is	O(1).	This	holds	true	as	shown	in	the	graph	for	
best	case	above:	no	matter	the	size	of	the	data	(N),	the	best	case	will	always	
remain	1	for	both	implementations	as	the	term	being	searched	for	would	be	
found	in	the	root	node	in	the	binary	search	tree	or	the	first	index	position	of	the	
array.	The	average	case	for	a	binary	search	tree	is	expected	to	be	O(log	n)	and	
the average	case,	whereas	a	linear	search	in	the	average	case	of	an	array	is	
expected	to	be	O(n).	This	for	the	most	part	holds	true	in	the	average	case	graph	
as	can	be	seen	above:	The	binary	search	tree	outperforms	the	array	in	a	massive	
way	– this	is	due	to	the	binary	search	tree	logarithmic	and	recursive	nature	as	it	
uses	comparisons	effectively	to	navigate	the	tree.	The	worst	case	for	a	binary	
search	tree	is	expected	to	be	o(log	n)	whereas	the	worst	case	for	an	array	is	o(n).	
As	shown	in	the	graph	above,	the	array	implementation	shows	that	depending	
on	the	size	of	N,	in	the	worst	case	it	will	perform	N	operations	for	searching	as	it	
has	to	traverse	the	entire	array.	However	because	a	Binary	Search	tree	does	not	
need	to	traverse	through	all	its	nodes	it	has	an	expected	o(log	n)	in	the	worst	
case.	The	worst	case	for	a	dataset	of	size	500	for	an	array	was	500	traversals	
however	in	the	binary	search	tree	it	can	be	seen	that	there	are	more	than	ten	
times	less	comparison	operations	needed	and	thus	outperforms	the	array	
